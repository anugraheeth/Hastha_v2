...
const Hosdetails = () => {
  ...
  const getData = async() =>{
      try {
        ...
        setLoading(true);
        const response = await get('api/auth/hosdetails');
        ...
        <div className="flex-1 flex flex-col">
          <header className="w-full flex items-center justify-between bg-white shadow-md p-4">
            <div className="flex items-center">
              ...
              <h2 className="ml-4 text-xl font-semibold text-gray-700">HOSPITAL DETAILS</h2>
            </div>
                ...
                <table className="min-w-full table-auto">
                  <thead className="bg-gray-200">
                    <tr>
                      ...
                      <th className="p-4 text-sm text-gray-500 text-start">Institution Name</th>
