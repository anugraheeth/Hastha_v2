...
const Comdetails = () => {
  ...
  const getData = async() =>{
      try {
        ...
        setLoading(true);
        const response = await get('api/auth/comdetails');
  ...
  const handleDownloadCSV = () => {
    const csvData = [
      ["Building No", "Owner Name ", "Bussiness Name", "Type"],
      ...filteredUsers.map((user) => [user.building_number, user.name_of_business_owner, user.name_of_businness, user.type_of_businnes]),
    ];
  ...
  const handleDownloadPDF = () => {
    ...
    doc.autoTable({
      head: [["Building No", "Owner Name ", "Bussiness Name", "Type"]],
      body: tableData,
    });
    doc.save("users.pdf");
  };
  ...
  <user>
    ...
    <Bussiness_Name>${user.name_of_businness}</Bussiness_Name>
    <Type>${user.type_of_businnes}</Type>
  </user>`
      )
      .join("");
        ...
        <div className="flex-1 flex flex-col">
          <header className="w-full flex items-center justify-between bg-white shadow-md p-4">
            <div className="flex items-center">
              ...
              <h2 className="ml-4 text-xl font-semibold text-gray-700">COMERCIAL DETAILS</h2>
            </div>
                ...
                <table className="min-w-full table-auto">
                  <thead className="bg-gray-200">
                    <tr>
                      ...
                      <th className="p-4 text-sm text-gray-500 text-start">Bussiness Name</th>
                      <th className="p-4 text-sm text-gray-500 text-start">Bussiness Type</th>
                    </tr>
                  </thead>
                  <tbody >
